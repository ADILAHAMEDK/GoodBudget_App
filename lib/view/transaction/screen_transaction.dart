      ...
      body: Column(
        ...
        children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: SizedBox(
                        width: 64,
                        height: 50,
                        child:Image.asset("assets/images/money manager logo.png",),
                      ),
                      ),
                  ),
                 const SizedBox(
              ...
              Expanded(
                child: Padding(
                  ...
                  child: IconButton(onPressed: (){
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> const ScreenSearchPage()));
         ...
         // crossAxisAlignment: CrossAxisAlignment.end,
           ...
           GestureDetector(
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>  HistoryPage(allTransactions: newList,),)),
            child:const Align(
