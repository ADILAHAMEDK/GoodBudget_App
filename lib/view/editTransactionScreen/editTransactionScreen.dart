...
import '../../controller/provider/editPageProvider.dart';
import '../homeScreen/home_screen.dart';
...
class _EditPageState extends State<EditPage> {
  late EditPageProvider _provider;
  ...
  void initState() {
    super.initState();
    _provider = EditPageProvider(widget.transaction);
    _amountTextEditingController.text = widget.transaction.amount.toString();
    _purposeTextEditingController.text = widget.transaction.purpose;
    _selectedDate = widget.transaction.date;
    _selectedCategoryType = widget.transaction.type;
  ...
  void updateTransaction(EditPageProvider provider) {
    final newAmount = double.parse(provider.amountTextEditingController.text);
    final newPurpose = provider.purposeTextEditingController.text;
    ...
    // Update the transaction category type (income or expense)
  }}
